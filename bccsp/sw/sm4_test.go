...
func Test_SM4_CBCPKCS7EncryptCBCPKCS7Decrypt(t *testing.T) {
	t.Parallel()
...
func Test_SM4_PKCS7Padding(t *testing.T) {
	t.Parallel()
...
func Test_SM4_PKCS7UnPadding(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCEncryptCBCPKCS7Decrypt_BlockSizeLengthPlaintext(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCPKCS7EncryptCBCDecrypt_ExpectingCorruptMessage(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCPKCS7Encrypt_EmptyPlaintext(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCEncrypt_EmptyPlaintext(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCPKCS7Encrypt_VerifyRandomIVs(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCPKCS7Encrypt_CorrectCiphertextLengthCheck(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCEncryptCBCDecrypt_KeyMismatch(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCEncryptCBCDecrypt(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCEncryptWithRandCBCDecrypt(t *testing.T) {
	t.Parallel()
...
func Test_SM4_CBCEncryptWithIVCBCDecrypt(t *testing.T) {
	t.Parallel()
...
func Test_SM4_AESRelatedUtilFunctions(t *testing.T) {
	t.Parallel()
...
func Test_SM4_SM4CBCEncryptInvalidInputs(t *testing.T) {
	t.Parallel()
...
func Test_SM4_sm4CBCDecryptInvalidInputs(t *testing.T) {
	t.Parallel()
...
func Test_SM4_SM4CBCPKCS7EncryptorDecrypt(t *testing.T) {
	t.Parallel()
...
func Test_SM4_SM4CBCPKCS7EncryptorWithIVSameCiphertext(t *testing.T) {
	t.Parallel()
...
func Test_SM4_SM4CBCPKCS7EncryptorWithRandSameCiphertext(t *testing.T) {
	t.Parallel()
